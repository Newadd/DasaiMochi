// ==================================================
// DASAI MOCHI PRO - FULL CODE dengan Fallback
...
// ========== NONAKTIFKAN BROWN OUT (opsional) ==========
// Hapus komentar jika masih brownout
// #include "soc/soc.h"
...
void getWeatherAndForecast() {
  ...
  if (http.GET() == 200) {
    ...
    Serial.println("Forecast HTTP error");
  }
  http.end();
}
